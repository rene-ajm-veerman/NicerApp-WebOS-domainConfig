...
?>
    ...
    <div style="max-width:1000px;margin:8px;padding:8px;border-radius:5px;background:rgba(250, 233, 52,0.35);background:rgba(0,0,250,0.47);box-shadow:0px 0px 8px 4px rgba(0,0,0,0.631), 2px 2px 2px rgba(0,0,0,0.7);line-height:1.5em;">
        ...
        <p style="padding:8px;border-radius:5px;margin-block-start:0;margin-block-end:0;margin-inline-start:0;margin-inline-end:0;">
        Opensourced <a href="https://github.com/rene-ajm-veerman/nicerApp-WebOS-5.10.z" class="nomod noPushState" target="naGithub">v5.10.1 on Github.com</a>, <a href="https://github.com/rene-ajm-veerman/nicerApp-WebOS-5.11.z" class="nomod noPushState" target="naGithub11">v5.11.0 on Github.com</a> and available as <a href="https://nicer.app/downloads" class="nomod noPushState" target="naDownload">full package here</a>, <br/>and the latest -not always stable- <a href="https://new.nicer.app" class="nomod noPushState" target="newNA">development version here</a>.
        </p>
    </div>
